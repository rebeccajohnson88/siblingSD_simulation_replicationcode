...
simulated_df_withadd <- readRDS("simulated_1000rep_interceptcor0.01.RDS")
...
saveRDS(pool_lm_noeffect_confound_bothsibs_pvals_df, 
        file = "pool_lm_mean_simres_cor001.RDS") 
saveRDS(pool_lm_noeffect_confound_stratcontrol_bothsibs_pvals_df, 
        file = "pool_lm_mean_simres_stratcontrol_cor001.RDS") 
...
print("fe finished")
saveRDS(fe_lm_noeffect_confound_bothsibs_pvals_df, file = "fe_lm_mean_simres_cor001.RDS")   
...
saveRDS(re_lm_noeffect_confound_bothsibs_pvals_df, 
        file = "re_lm_mean_simres_cor001.RDS")  
saveRDS(re_lm_noeffect_confound_stratcontrol_bothsibs_pvals_df, 
        file = "re_lm_mean_simres_stratcontrol_cor001.RDS")  
...
saveRDS(haus_refe_nopopstratcontrol, file = "haus_refe_nopopstratcontrol_cor001.RDS")
saveRDS(haus_refe_nopopstratcontrol, file = "haus_refe_popstratcontrol_cor001.RDS")
